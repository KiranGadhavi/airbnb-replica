...
function FooterComponent(){
    ...
    // const handleShowMore = (showMoreTab) => {
    //     setActiveTab(showMoreTab);
    //     setShowMore(false); // Reset showMore when switching tabs
    //   };
    ...
    return(
        ...
        <div className="flex pt-4 button">
           <div className="">
            <button onClick={() => handleTabClick('Tab1')} className={` ${activeTab === 'Tab1' ? 'active font-bold border-b-2 border-black' : ''}`}>Popular</button>
           </div>
           <div className="px-6">
            <button onClick={() => handleTabClick('Tab2')} className={activeTab === 'Tab2' ? 'active font-bold border-b-2 border-black' : ''}>Historic</button>
           </div>
           <div className="">
            <button onClick={() => handleTabClick('Tab3')} className={activeTab === 'Tab3' ? 'active font-bold border-b-2 border-black' : ''}>Coastal</button>
           </div>
           <div className="px-6">
            <button onClick={() => handleTabClick('Tab4')} className={activeTab === 'Tab4' ? 'active font-bold border-b-2 border-black' : ''}>Islands</button>
           </div>
           <div className="">
            <button onClick={() => handleTabClick('Tab5')} className={activeTab === 'Tab5' ? 'active font-bold border-b-2 border-black' : ''}>Lakes</button>
           </div>
           <div className="px-6">
            <button onClick={() => handleTabClick('Tab6')} className={activeTab === 'Tab6' ? 'active font-bold border-b-2 border-black' : ''}>Unique stays</button>
           </div>
           <div className="">
            <button onClick={() => handleTabClick('Tab7')} className={activeTab === 'Tab7' ? 'active font-bold border-b-2 border-black' : ''}>Categories</button>
           </div>
           <div className="px-6">
            <button onClick={() => handleTabClick('Tab8')} className={activeTab === 'Tab8' ? 'active font-bold border-b-2 border-black' : ''}>Things to do</button>
           </div>
     ...
     {/* jfdkfg add button */}
                    ...
                    <div>
                        ...
                        <ul  className="flex ">
                            ...
                            <li className="flex-col px-28 mx-12">
                                <div className="font-bold">Amsterdam </div>
                                </li>
                            <li  className="flex-col mx-18">
                                <div className="font-bold">Athens </div>
                            </li>
  ...
  <div class="flex flex-col md:flex-row md:space-x-4">
    ...
    <div class="w-full md:w-1/3 bg-blue-400 p-4">Div 3</div>
        ...
        <section className="flex flex-row px-20 py-8 ">
            ...
            <article className="basis-1/3 px-6 space-y-4">
                <div className="flex-col font-bold">Hosting</div>
                <ul className="space-y-4 ">
        ...
        <hr className="pt-2"/>
            <article className="basis-3/4 ">
                ...
                <span className="flex-col ">© 2024 AirbnbReplica, Inc.</span>
            ...
            <button className="flex-col px-6">
            <span>£</span>
            <span>GBP</span>
            </button>
            <button className="px-2">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" className="h-4 w-4 " aria-label="Navigate to Facebook" role="img" focusable="false"><path d="M30 0a2 2 0 0 1 2 2v28a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2V2a2 2 0 0 1 2-2z"></path><path fill="#fff" d="M22.94 16H18.5v-3c0-1.27.62-2.5 2.6-2.5h2.02V6.56s-1.83-.31-3.58-.31c-3.65 0-6.04 2.21-6.04 6.22V16H9.44v4.62h4.06V32h5V20.62h3.73z"></path></svg>
            </button>
            <button className="px-2">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" className="h-4 w-4 " aria-label="Navigate to Twitter" role="img" focusable="false"><path d="M32 4v24a4 4 0 0 1-4 4H4a4 4 0 0 1-4-4V4a4 4 0 0 1 4-4h24a4 4 0 0 1 4 4z"></path><path fill="#fff" d="M18.66 7.99a4.5 4.5 0 0 0-2.28 4.88A12.31 12.31 0 0 1 7.3 8.25a4.25 4.25 0 0 0 1.38 5.88c-.69 0-1.38-.13-2-.44a4.54 4.54 0 0 0 3.5 4.31 4.3 4.3 0 0 1-2 .06 4.64 4.64 0 0 0 4.19 3.13A8.33 8.33 0 0 1 5.8 23a12.44 12.44 0 0 0 19.32-11.19A7.72 7.72 0 0 0 27.3 9.5a8.3 8.3 0 0 1-2.5.75 4.7 4.7 0 0 0 2-2.5c-.87.5-1.81.87-2.81 1.06a4.5 4.5 0 0 0-5.34-.83z"></path></svg>
            </button>
             <button className="px-2">
             <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" className="h-4 w-4 " aria-label="Navigate to Instagram" role="img" focusable="false"><path d="M30 0H2a2 2 0 0 0-2 2v28c0 1.1.9 2 2 2h28a2 2 0 0 0 2-2V2a2 2 0 0 0-2-2z"></path>
